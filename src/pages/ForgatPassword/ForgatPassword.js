    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.juggling}>
        <Image
          ...
          source={require('../../assets/juggling.png')}
        />
      </View>
      <View style={{flex: 2, paddingHorizontal: 30}}>
        ...
        <View>
          <Image
            style={styles.logo022}
            source={require('../../assets/email.png')}
          />
          <Input style={styles.email} placeholder="Email Address" />
        </View>
        <Text style={styles.message}>
          A message will be sent to your address with further instructions
        </Text>
        <TouchableOpacity activeOpacity={0.8} onPress={()=>recoverPassword()} style={styles.LoginButton}>
